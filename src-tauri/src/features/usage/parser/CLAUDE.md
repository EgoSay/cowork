...
- `claude_code.rs`: scans ~/.claude/projects/**/*.jsonl (含 subagents, mtime via super::LOOKBACK_DAYS), dedup by messageId:requestId (first-wins, 对齐 ccusage), sums per (date, model)
